...
namespace _10bonusScore
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter a digit between 1-9:");
            ...
            switch (choice)
            {
                ...
                case 2:
                case 3:
                    Console.WriteLine(choice * 10);
                    break;
                case 4:
                case 5:
                case 6:
                    Console.WriteLine(choice * 100);
                    break;
                case 7:
                case 8:
                case 9:
                    Console.WriteLine(choice*1000);
                    break;
                default:
